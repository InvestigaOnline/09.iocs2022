...
-   antecesor, identifica si es una clave de nivel superior o una subclave de la anterior (representación de *nets*)
-   descripción, literal codificado
-   código / frecuencia, código de la clave o frecuencia del literal según campo *tipo*.
