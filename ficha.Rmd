...
El enlace fue visitado por `r xw`, de los que `r xy` iniciaron la entrevista no acabando la misma, `r xz` fueron rechazados por los diversos controles en el _screening_ del proyecto, y por tanto, hubo `r xx` participantes que la consiguieron acabar. Sobre una muestra de `r xn` entrevistas, hay un ratio de respuesta de `r round(tasa,1)` %. 
