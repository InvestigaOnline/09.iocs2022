...
El enlace fue visitado por `r xw`, de los que `r xy` iniciaron la entrevista no acabando la misma, y por tanto, hubo `r xx` participantes que la consiguieron acabar. Hay un ratio de respuesta de `r round(RR3,1)` %. 
```{r echo = FALSE}
ficha <-
    data.frame (
     Dato = c(
