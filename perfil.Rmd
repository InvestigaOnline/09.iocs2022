...
Muestra piloto obtenida con estudiantes Universitat de València (Máster MBA Dirección de Empresas), por lo que el muestreo de conveniencia ha sido el método indicado. Ello nos lleva a una muestra sesgada de individuos, no representativos de la estructura poblacional del universo señalado en la [ficha técnica](https://caso2022.investigaonline.com/ficha.html). Posteriormente a la muestra piloto, se han añadido participantes contactos en redes sociales de estudiantes de grado de la Universidad Católica de Valencia (ADE-Plan de marketing, 3er año.)
...
Para continuar analizando quiens habían comprado en los últimos 3 meses en una de las tiendas de TENDAM o INDITEX, grupos de análisis en nuestra investigación.
